...
let stories = new Zuck("stories", {
  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      "user-3",
      "../../static/assets/images/post/1by1/03.jpg",
      "Billy Vasquez",
      "",
      timestamp(),
      [
        ["user3-story1", "photo", 5, "../../static/assets/images/albums/03.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      ...
      timestamp(),
      [
        ["user4-story1", "photo", 5, "../../static/assets/images/albums/04.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-5",
      "../../static/assets/images/post/1by1/05.jpg",
      "Lori Stevens",
      "",
      timestamp(),
      [
        ["user5-story1", "photo", 5, "../../static/assets/images/albums/05.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-6",
      "../../static/assets/images/post/1by1/06.jpg",
      "Samuel Bishop",
      "",
      timestamp(),
      [
        ["user6-story1", "photo", 5, "../../static/assets/images/albums/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-7",
      "../../static/assets/images/post/1by1/07.jpg",
      "Joan Wallace",
      "",
      timestamp(),
      [
        ["user7-story1", "photo", 5, "../../static/assets/images/albums/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    {
      id: "user-8",               // story id
      photo: "../../static/assets/images/albums/05.jpg",            // story photo (or user photo)
